...
# FormComponent - A highly flexible form builder component
#
# == Basic Usage:
...
#   :password            - Password input (secure)
...
#      minlength: 8,             # Minimum length for text fields
#      maxlength: 255,           # Maximum length for text fields
#      min: 0,                   # Minimum value for number/date fields
#      max: 100,                 # Maximum value for number/date fields
#      step: 0.1,                # Step increment for number/range fields
...
# 3. Custom Styling:
#    {
#      input_html: {             # Pass attributes to input element
#        class: "custom-class",
#        autocomplete: "email",
#        data: { controller: "custom" }
#      },
#      wrapper_html: {           # Pass attributes to wrapper div
#        class: "col-span-2"
#      }
#    }
#
# 4. Label & Help Text:
#    {
#      label: "Email Address",   # Custom label (or false to hide)
#      hint: "We'll never share" # Help text below field
#    }
#
# 5. Select/Radio Options:
#    {
#      as: :select,
#      collection: [             # Options for select/radio
#        ["Label 1", "value1"],
#        ["Label 2", "value2"]
#      ],
#      include_blank: "Choose..." # Blank option for select
#    }
#
# 6. Custom HTML (Advanced):
#    # Use a Proc to generate completely custom HTML:
#    {
#      name: :custom_field,
#      custom_html: ->(form, field, component) {
#        content_tag(:div, class: "custom-wrapper") do
#          form.text_field(field[:name], class: "my-custom-input")
#        end
#      }
#    }
#
#    # Or pass raw HTML string:
#    {
#      name: :raw_html,
#      custom_html: '<input type="text" class="custom" />'
#    }
#
# 7. Additional Options:
#    {
#      options: {                # Any additional HTML5 attributes
#        title: "Tooltip text",
#        inputmode: "numeric",
#        list: "datalist-id"
#      }
...
#         columns: 2,             # Grid layout (1, 2, 3, etc.)
#         fields: [
#           { name: :first_name },
#           { name: :last_name }
#         ]
...
#         name: :role,
#         as: :select,
#         collection: [["Admin", "admin"], ["User", "user"]],
